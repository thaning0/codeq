...
The gate consumes the committed 0.5.1 performance artifact and 0.5.2 historical replay artifact. At 0.5.3 all readiness checks passed, and `1.0.0rc2` is now the active release candidate after a CLI stream-contract fix.
