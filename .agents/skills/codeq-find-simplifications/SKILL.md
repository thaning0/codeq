...
1. **Fix the scope.** Read [AGENTS.md](../../../AGENTS.md), [README.md](../../../README.md), and the maintained document that owns the selected behavior. Start with [codeq 1.0 readiness](../../../docs/codeq-1.0-readiness.md) for the frozen product and compatibility boundary. Treat historical plans, validation reports, benchmarks, and superseded release-candidate notes as discovery evidence, not current authority.
